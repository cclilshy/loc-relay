package com.cclilshy.tayd.app;

import com.cclilshy.tayd.event.runtime.EventNotificationListenerService;
import com.cclilshy.tayd.event.permission.NotificationListenerConnectionPolicy;
import com.cclilshy.tayd.event.permission.EventListenerPermissions;
...
import com.cclilshy.tayd.event.domain.EventListenerSubscriptionState;
import com.cclilshy.tayd.event.domain.EventListenerSubscriptionPolicy;
import com.cclilshy.tayd.webhook.runtime.WebhookDispatcher;
import com.cclilshy.tayd.webhook.data.WebhookChannelStore;
import com.cclilshy.tayd.webhook.domain.WebhookChannel;
import com.cclilshy.tayd.qr.ui.QrScanActivity;
import com.cclilshy.tayd.qr.domain.ServerScanPayload;
import com.cclilshy.tayd.network.domain.NetworkInterfaceInfo;
import com.cclilshy.tayd.network.android.NetworkInfoProvider;
import com.cclilshy.tayd.proxy.domain.ProxyMapping;
import com.cclilshy.tayd.frpc.data.FrpcProxyStore;
import com.cclilshy.tayd.frpc.runtime.FrpcProcess;
import com.cclilshy.tayd.gateway.runtime.GatewayRuntimeState;
import com.cclilshy.tayd.gateway.runtime.GatewayService;
...
import com.cclilshy.tayd.gateway.domain.GatewayExtensionSummary;
import com.cclilshy.tayd.gateway.domain.GatewayExtensionCatalog;
import com.cclilshy.tayd.gateway.domain.GatewayExtension;
import com.cclilshy.tayd.common.permission.NotificationPermissionPolicy;
import com.cclilshy.tayd.common.permission.AutoStartPermissionPolicy;
...
public final class MainActivity extends AppCompatActivity {
    ...
    private View buildHomePage() {
        ...
        TextView title = text("Tayd", 26, COLOR_TEXT, true);
    ...
    private void requestEventListenerPermission(int requestCode, String prefKey) {
        ...
        Toast.makeText(this, "Enable notification access for Tayd", Toast.LENGTH_SHORT).show();
    }
    ...
    private void requestServiceNotificationPermission(int pendingReason) {
        ...
        Toast.makeText(this, "Enable notifications for Tayd", Toast.LENGTH_SHORT).show();
    }
