package com.cclilshy.locrelay.gateway.runtime;

import com.cclilshy.locrelay.proxy.engine.Socks5ProxyServer;
import com.cclilshy.locrelay.proxy.engine.HttpConnectProxyServer;
import com.cclilshy.locrelay.proxy.domain.ProxyAuth;
import com.cclilshy.locrelay.frpc.runtime.FrpcProcess;
import com.cclilshy.locrelay.gateway.data.GatewaySettings;
...
public final class GatewayService extends Service {
    public static final String ACTION_START = "com.cclilshy.locrelay.START";
    public static final String ACTION_STOP = "com.cclilshy.locrelay.STOP";
