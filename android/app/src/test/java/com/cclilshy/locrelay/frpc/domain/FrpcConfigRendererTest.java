package com.cclilshy.locrelay.frpc.domain;
...
public class FrpcConfigRendererTest {
    ...
    public void rendersServerAuthAndAppPrivateIncludes() {
        ...
        String config = FrpcConfigRenderer.renderClient(
                ...
                7000,
                "token\"with\\slashes",
                "/data/user/0/com.cclilshy.locrelay/files/frpc.d",
        ...
        assertTrue(config.contains("includes = [\"/data/user/0/com.cclilshy.locrelay/files/frpc.d/*.toml\"]"));
    }
